...
func TestMigration0018_IsTheOnlyOneThisTicketAdds(t *testing.T) {
	...
	for _, e := range entries {
		...
		// 31 is SWT-40 Part C's (inquiry-promote: projects.inquiry_promote_after,
		// the inquiry lane's own promotion cutover), named by its SPEC's
		...
		// 43 is SWT-79's (slack-channel-mentions: capture_decisions.channel_unmentioned,
		// the mention gate on the inquiry lane, and the #a-millon project row).
		...
		// name beside the SWT-52 marker), named by its SPEC's data-model section as
		// 0036_task_working_session.sql. Its own guard is internal/tools
		// TestMigration0036_TaskWorkingSessionShape.
		// 37 is SWT-66's (microsoft-oauth-mail: auth_type gains 'xoauth2' and an
		...
		// SWT-89: 44 is board-streaming's (0044_board_changed_notify.sql), noted here
		// below the marker so the window guards above it keep their reach.
		if n > 17 && n != 18 && n != 19 && n != 20 && n != 21 && n != 22 && n != 23 && n != 24 && n != 25 && n != 26 && n != 27 && n != 28 && n != 29 && n != 30 && n != 31 && n != 32 && n != 33 && n != 34 && n != 35 && n != 36 && n != 37 && n != 38 && n != 39 && n != 40 && n != 41 && n != 42 && n != 43 && n != 44 {
