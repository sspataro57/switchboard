...
func TestMigration0018_IsTheOnlyOneThisTicketAdds(t *testing.T) {
	...
	for _, e := range entries {
		...
		// went to SWT-43, 0029 to Part D, and 0030 is claimed by SWT-45
		// (jira-activity-revive) on another branch — whichever merges second
		// renumbers, and this line learns it.
		...
		if n > 17 && n != 18 && n != 19 && n != 20 && n != 21 && n != 22 && n != 23 && n != 24 && n != 25 && n != 26 && n != 27 && n != 28 && n != 29 && n != 31 {
